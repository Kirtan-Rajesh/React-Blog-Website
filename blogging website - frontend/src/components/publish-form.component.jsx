        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16  lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    <p className="text-dark-grey mb-2 mt-9">Title of Your Blog </p>
                    <input type="text" placeholder="Blog Title" defaultValue={title} className="input-boxpl-4 " onChange={handleBlogTitleChange}></input>

                    <p className="text-dark-grey mb-2 mt-9">Short description about your blog.</p>
                    <textarea maxLength={charLimit}  defaultValue={ des } className="h-40 resize-none leading-7 input-box pl-4" onChange={handleBlogDescriptionChange}
